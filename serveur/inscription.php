        ...
        <div class="col-md-4 col-md-offset-4" id="marge">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control sub" id="nom" name="nom" placeholder="Nom">
                </div>
                <div class="form-group">
                    <label for="prenom">Prénom :</label>
                    <input type="text" class="form-control sub" id="prenom" name="prenom" placeholder="Prénom">
                </div>
                <div class="form-group">
                    <label for="pseudo">Pseudo :</label>
                    <input type="text" class="form-control sub" id="pseudo" name="pseudo" placeholder="Pseudo">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_naissance" class="colortext sub">
                </div>
                <div class="form-group">
                    <label for="email">Email :</label>
                    <input type="email" class="form-control sub" id="email" name="email" placeholder="Email">
                </div>
                <div class="form-group">
                    <label for="mdp">Mot de Passe :</label>
                    <input type="password" class="form-control sub" id="mdp" name="mdp" placeholder="Mot de Passe">
                </div>
                <div class="form-group">
                    <label for="mdp2">Confirmation Mot de Passe :</label>
                    <input type="password" class="form-control sub" id="mdp2" name="mdp2"
